...
runSampleValueIteration:
	python3 ValueIteration.py 10 10 -start 1 1 -end 9 9 -k 0 -gamma 0.8 -epochs 100 -learningRate 0.1
runSampleQLearning:
	python3 QLearning.py 10 10 -start 1 1 -end 9 9 -k 5 -gamma 0.8 -epochs 100 -learningRate 0.1
setup:
